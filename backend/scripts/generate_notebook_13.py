"""
backend/scripts/generate_notebook_13.py
---------------------------------------
Generates notebooks/13_auth_evaluation.ipynb for Module 13.
Run: python backend/scripts/generate_notebook_13.py
"""
...
OUTPUT = ROOT / "notebooks" / "13_auth_evaluation.ipynb"
...
CELLS = [
    ...
    {
        "cell_type": "markdown",
        "source": ["## 1. Password Hashing & Verification (Bcrypt)\n"]
    },
    {
        "cell_type": "code",
        "source": [
    ...
    {
        "cell_type": "markdown",
        "source": ["## 2. JWT Access Token Creation & Validation\n"]
    },
    {
        "cell_type": "code",
        "source": [
    ...
    {
        "cell_type": "markdown",
        "source": ["## 3. End-to-End Auth API Flow (TestClient)\n"]
    },
    {
        "cell_type": "code",
        "source": [
    ...
    {
        "cell_type": "markdown",
        "source": ["## 4. Protected Route Verification\n"]
    },
    {
        "cell_type": "code",
        "source": [
